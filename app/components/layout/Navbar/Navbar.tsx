  ...
  const navList = (
    <ul className='mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6'>
      ...
      >
        ...
        <Link href='/pkk-pokjaI' className='flex items-center'>
          Pokja I
        </Link>
      </Typography>
      ...
      >
        ...
        <Link href='/pkk-pokjaII' className='flex items-center'>
          Pokja II
        </Link>
      </Typography>
      ...
      >
        ...
        <Link href='/pkk-pokjaIV' className='flex items-center'>
          Pokja IV
        </Link>
      </Typography>
      ...
      >
        ...
        <Link href='/stunting' className='flex items-center'>
          Stunting
        </Link>
      </Typography>
    </ul>
